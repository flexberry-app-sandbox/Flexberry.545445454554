...
namespace IIS.545445454554
{
    ...
    [View("ЛогистикаE", new string[] {
            ...
            "СлужбаДоставки.Наименование as \'Наименование службы доставки\'"}, Hidden=new string[] {
    ...
    [View("ЛогистикаL", new string[] {
            ...
            "Состояние as \'Состояние\'",
            "Информация as \'Информация\'",
            "СлужбаДоставки.Наименование as \'Наименование службы доставки\'"})]
    public class Логистика : ICSSoft.STORMNET.DataObject
    {
        
        private int fНомер;
        
        private IIS.545445454554.Состояние fСостояние;
        ...
        public virtual IIS.545445454554.Состояние Состояние
        {
            get
            {
                ...
                IIS.545445454554.Состояние result = this.fСостояние;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЛогистикаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаE", typeof(IIS.545445454554.Логистика));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛогистикаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаL", typeof(IIS.545445454554.Логистика));
                }
            }
        }
    }

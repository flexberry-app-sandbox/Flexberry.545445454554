...
namespace IIS.545445454554
{
    ...
    [View("ПосылкаE", new string[] {
            ...
            "Транзакция.Время as \'Время транзакции\'",
            ...
            "Логистика.Информация as \'Информация о посылке\'",
            "Логистика.Состояние as \'Состояние посылки\'",
            "Ключ as \'Сгенерированный код\'",
            "Ключ.СгенКлюч as \'Сгенерированный код\'"}, Hidden=new string[] {
            "Транзакция.Время",
            "Ключ.СгенКлюч"})]

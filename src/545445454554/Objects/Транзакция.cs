...
namespace IIS.545445454554
{
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.545445454554.Оплата fОплата;
        
        private double fСумма;
        
        private IIS.545445454554.Пользователь fПользователь;
        ...
        public virtual IIS.545445454554.Оплата Оплата
        {
            get
            {
                ...
                IIS.545445454554.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "Пользователь"})]
        [NotNull()]
        public virtual IIS.545445454554.Пользователь Пользователь
        {
            get
            {
                ...
                IIS.545445454554.Пользователь result = this.fПользователь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТранзакцияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияE", typeof(IIS.545445454554.Транзакция));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТранзакцияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТранзакцияL", typeof(IIS.545445454554.Транзакция));
                }
            }
        }
    }
